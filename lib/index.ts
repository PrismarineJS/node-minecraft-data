import mcDataToNode from "./lib/loader";
...
export function (mcVersion: string, preNetty: boolean) {
...
function toMajor(mcVersion: string, preNetty: boolean, typeArg?: string) {
