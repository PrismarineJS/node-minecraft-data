...
function mcDataToNode (mcData) {
  ...
  return {
    ...
    findItemOrBlockById: function (id) {
      console.log('{mcData}.findItemOrBlockById() is deprecated, scheduled to be removed on or after June 1 2022')
      const item = indexes.itemsById[id]
      if (item !== undefined) return item
      return indexes.blocksById[id]
    },
    findItemOrBlockByName: function (name) {
      console.log('{mcData}.findItemOrBlockByName() is deprecated, scheduled to be removed on or after June 1 2022')
