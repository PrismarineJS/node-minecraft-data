...
function mcDataToNode(mcData) {
  ...
  return {
    ...
    blockStates: mcData.blockStates, // bedrock edition only
    ...
    protocolYaml: [mcData.proto, mcData.types], // bedrock edition only

    defaultSkin: mcData.steve, // bedrock edition only
