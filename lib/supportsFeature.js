...
module.exports = (versionObj, versions) => {
  ...
  const newestMajor = versions.reduce((acc, cur) => { acc[cur.majorVersion] = acc[cur.majorVersion] || cur; return acc }, {})
  const oldestMajor = versions.reduce((acc, cur) => { acc[cur.majorVersion] = cur; return acc }, {})
