...
const templateTypings = fs.readFileSync(path.resolve(__dirname, './index-template.d.ts'));
...
async function generate() {
  ...
  let typingString = (await Promise.all(walkSync(path.resolve(__dirname, '../minecraft-data/schemas')).map(async (schemaPath) => {
